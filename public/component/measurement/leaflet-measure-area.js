! function(e) {
    ...
    L.Control.MeasureArea = L.Control.extend({
        _className: "leaflet-measure-area",
        options: {
            units: {},
            position: "topright",
            ...
            captureZIndex: 1e4,
            popupOptions: {
                className: "leaflet-measure-area-resultpopup",
        ...
        measureAreaControl: !1
    }), L.Map.addInitHook(function() {
        this.options.measureAreaControl && (this.measureAreaControl = (new L.Control.MeasureArea).addTo(this))
    }), L.control.measureArea = function(e) {
        return new L.Control.MeasureArea(e)
    }
