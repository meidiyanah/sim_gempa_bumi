! function(e) {
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _initLayout: function() {
            ...
            }), t.setAttribute("aria-haspopup", !0), t.setAttribute('style', 'background-color: rgb(103, 134, 161); color: white;'), L.DomEvent.disableClickPropagation(t), L.DomEvent.disableScrollPropagation(t);
        ...
        _getMeasurementDisplayStrings: function(e) {
            ...
            return {
                lengthDisplay: t(e.length, this.options.primaryLengthUnit, this.options.secondaryLengthUnit, this.options.thirdLengthUnit, this.options.decPoint, this.options.thousandsSep),
                areaDisplay: t(e.area, this.options.primaryAreaUnit, this.options.secondaryAreaUnit, this.options.thirdAreaUnit, this.options.decPoint, this.options.thousandsSep)
            }
        },
    ...
    e.exports = '<a class="js-toggle" style="background-color: rgb(103, 134, 161);" href=# title="Measure distances and areas" id="rulernya"><img src="../image/measur.png" style="width: 50%;" title="Measure"></a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt">+ <a href=# class="js-start start" style="background-color: rgb(103, 134, 161); color: white;">New measurement</a> </ul> </div> <div class=js-measuringprompt> <center><h6>Measure Areas</h6><hr></center> <p class=js-starthelp>Start creating a measurement by adding points to the map</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel" style="color: white;">Cancel</a></li> <li><a href=# class="js-finish finish" style="color: white;">Finish measurement</a></li> </ul> </div> </div> '
}, function(e, t, r) {
    ...
    e.exports = '<center><h6>Point location</h6><hr></center> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this location</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}, function(e, t, r) {
    e.exports = '<center><h6>Linear measurement</h6><hr></center> <p class="js-linear-measurement">{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this line</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}, function(e, t, r) {
    // e.exports = '<center><h6>Area measurement</h6><hr></center> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perimeter</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this area</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
    e.exports = '<center><h6>Area measurement</h6><hr></center> <p class="js-area-measurement">{{ model.areaDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this area</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}]);