...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/')}}">
                <div class="sidebar-brand-icon">
                    <img src="{{ asset('/images/icon-color.png') }}" width="50px">
                </div>
                <div class="sidebar-brand-text mx-3">SIJAPAI</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Simulasi Jangkauan Gempa Bumi 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Page level custom scripts -->
    <script src="{{asset('assets/sb-admin2/js/demo/datatables-demo.js')}}"></script>
